class MultiPlayer {
	constructor(id, thisUser) {
		let u = DB.users[id];
		this.color = getColorDictColor(u.settings.userColor);
		this.id = u.id;
		if (id == thisUser) this.isPlayerAtThisEndpoint = true; else this.isPlayerAtThisEndpoint = false;
		this.score = 0;
	}
}
class SoloPlayer {
